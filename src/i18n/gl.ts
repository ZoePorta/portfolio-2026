export const gl = {
  ...
  site: {
    ...
    description: 'Zoe Porta, software engineer especializada en frontend. Constrúe interfaces tan sólidas por dentro como bonitas por fóra. Dispoñible para traballo en remoto.',
  },
